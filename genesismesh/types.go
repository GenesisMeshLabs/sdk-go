...
type CapabilityOffer struct {
	OfferorSovereignID  string            `json:"offeror_sovereign_id"`
...
// AgreementRecord is returned by offer, counter, and accept.
...
// TrustDecision is the input to POST /admin/trust-evidence.
